...
class SequenceLine():
    ...
    def removeLine(self):
        self.removeLineFunc(self.rowNumber,
                            [self.voltageEntry, self.currentEntry, self.timeSizeType, self.durationEntry,
                             self.removeLineButton, self.selectedLabel])