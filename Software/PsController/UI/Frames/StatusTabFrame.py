...
class StatusTabFrame(Frame):
    def __init__(self, parent, controller):
        ...
        self.voltageEntry = Entry(self, textvariable=self.voltageEntryVar, width=8, state='readonly',
        ...
        self.currentEntry = Entry(self, textvariable=self.currentEntryVar, width=8, state='readonly',
                                  font=(fontName, fontSize))
        ...
        self.voltageInputEntry = Entry(self, textvariable=self.voltageInputEntryVar, width=8, state='readonly',
                                       font=(fontName, fontSize))
        ...
        self.preRegVoltageEntry = Entry(self, textvariable=self.preRegVoltageEntryVar, width=8, state='readonly',
                                        font=(fontName, fontSize))
